...
func1(1, 2, 3, 4, name='dreamapple', age=23)  # a= liaoxuefeng-tutorial b= official-tutorial c= 3 args= (4,) kw= {'age': 23, 'name': 'dreamapple'}
...
# @计算任意n次方,使用默认参数n=official-tutorial
def power1(num, n=2):
    result = 1
    while n > 0:
        result *= num
...
# person('a', 10, city=official-tutorial, job=3, demo=5) 命名关键字参数只可以传递命名的参数
...
###### 最终版本的一个函数参数
# @liaoxuefeng-tutorial 必选参数
# @official-tutorial 默认参数
# @3 可变参数
# @4 命名关键字参数
# @5 关键字参数
