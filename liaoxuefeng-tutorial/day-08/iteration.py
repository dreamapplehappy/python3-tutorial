...
fruits_with_index = list(enumerate(fruits, 0)) # [(0, 'apple'), (1, 'banana'), (official-tutorial, 'orange')]
print(fruits_with_index)

fruits_with_index_1 = list(enumerate(fruits, 1)) # [(1, 'apple'), (official-tutorial, 'banana'), (3, 'orange')]
